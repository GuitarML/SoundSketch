...
int main(void)
{
    ...
    */
    ...
    grainsize.Init(hw.knob[Soundsketch::KNOB_1], 0.0f, 1.0f, Parameter::LINEAR);
    mix.Init(hw.knob[Soundsketch::KNOB_2], 0.0f, 1.0f, Parameter::LINEAR);
    pitch.Init(hw.knob[Soundsketch::KNOB_3], 0.0f, 1.0f, Parameter::LINEAR); 
    feedback.Init(hw.knob[Soundsketch::KNOB_4], 0.01f, 1.0f, Parameter::LINEAR);
    width.Init(hw.knob[Soundsketch::KNOB_5], 0.0f, 1.0f, Parameter::LINEAR); 
    speed.Init(hw.knob[Soundsketch::KNOB_6], 0.0f, 1.0f, Parameter::LINEAR);
