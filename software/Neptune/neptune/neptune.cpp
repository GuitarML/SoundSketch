...
int main(void)
{
    ...
    rsize.Init(hw.knob[Soundsketch::KNOB_1], 0.0f, 1.0f, ::daisy::Parameter::LINEAR);
    modify.Init(hw.knob[Soundsketch::KNOB_4], 0.0f, 1.0f, ::daisy::Parameter::LINEAR);

    delayTime.Init(hw.knob[Soundsketch::KNOB_3], 0.0f, 1.0f, ::daisy::Parameter::LINEAR);
    delayFDBK.Init(hw.knob[Soundsketch::KNOB_6], 0.0f, 1.0f, ::daisy::Parameter::LINEAR);

    mix.Init(hw.knob[Soundsketch::KNOB_2], 0.0f, 1.0f, ::daisy::Parameter::LINEAR);
    filter.Init(hw.knob[Soundsketch::KNOB_5], 0.0f, 1.0f, ::daisy::Parameter::CUBE);
