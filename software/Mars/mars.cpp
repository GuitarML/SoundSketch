...
int main(void)
{
    ...
    Level.Init(hw.knob[Soundsketch::KNOB_3], 0.0f, 1.0f, Parameter::LINEAR); // lower range for quieter level
    filter.Init(hw.knob[Soundsketch::KNOB_4], 0.0f, 1.0f, Parameter::CUBE);
    delayTime.Init(hw.knob[Soundsketch::KNOB_5], 0.0f, 1.0f, Parameter::LINEAR);
    delayFdbk.Init(hw.knob[Soundsketch::KNOB_6], 0.0f, 1.0f, Parameter::LINEAR); 
