...
// Updated for SoundSketch hardware
constexpr Pin SW_1_PIN = seed::D6; // Footswitch 1
constexpr Pin SW_2_PIN = seed::D5; // Footswitch 2
constexpr Pin SW_3_PIN = seed::D24;  // Switch 1  up
constexpr Pin SW_4_PIN = seed::D25;  // Switch 1  down
constexpr Pin SW_5_PIN = seed::D26;  // Switch 2  up
constexpr Pin SW_6_PIN = seed::D27;  // Switch 2  down
constexpr Pin SW_7_PIN = seed::D10;  // Switch 3  up
constexpr Pin SW_8_PIN = seed::D11;  // Switch 3  down
...
constexpr Pin PIN_EXPRESSION = seed::D21;
